...
def user_insert():
    ...
    admin_yn = bool(data.get('adminYn'))
    user_name = data.get('userName')
    user_email = data.get('userEmail')
    user_passwd = data.get('password')

    params = [user_name, user_email, user_passwd, admin_yn, auth_code, api_code]
    res = conn.callproc_return('sp_set_user_insert', params)
...
def user_pass_update():
    ...
    member_yn = int(conn.execute_return(proc, [user_id, old_passwd]).MemberYn)
