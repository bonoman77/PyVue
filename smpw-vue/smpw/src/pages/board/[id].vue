...
const toggleDisplayPostStatus = (event) => {
    // 폼 제출 방지
    if (event) event.preventDefault()
    // 화면 상에서만 상태 변경
    post.value.completed = !post.value.completed
}
...
const updatePost = async () => {
    ...
    const postData = {
        ...
        completed: post.value.completed,
            ...
            <div v-if="editing" class="col-6">
                <div class="form-group">
                    ...
                    <button 
                        ...
                        type="button"
                        class="btn w-100"
                        :class="post.completed ? 'btn-success' : 'btn-danger'"
                        @click="toggleDisplayPostStatus"
                    >
