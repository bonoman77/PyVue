...
from mpw_manager.utils.file_handler import file_download
from mpw_manager.utils.log_handler import setup_logger
from mpw_manager.config import get_config
...
def register_blueprints(app):
    """모든 블루프린트를 앱에 등록"""
    from mpw_manager.router import homes, accounts, admins, boards, manages
    # 각 모듈의 블루프린트 등록
