...
def init_app(app):
    ...
    app.template_filter('route_kind_info')(route_kind_info)
    app.template_filter('service_kind_name')(service_kind_name)
    app.template_filter('product_kind_name')(product_kind_name)
    app.template_filter('board_kind_name')(board_kind_name)
    app.template_filter('booklet_kind_name')(booklet_kind_name)
    app.template_filter('background_url')(background_url)
    app.template_filter('logo_url')(logo_url)
    app.template_filter('product_comment')(product_comment)
    app.template_filter('highlight_search')(highlight_search)
