...
var defaults = {
  ...
  classNames: {
    ...
    modalVideoCloseBtn: 'js-modal-video-dismiss-btn'
  },
  aria: {
...
var ModalVideo = function () {
  ...
  _createClass(ModalVideo, [{
    ...
    value: function getVideoUrl(opt, channel, videoId) {
      ...
      } else if (channel === 'vimeo-showcase') {
        return this.getVimeoShowcase(opt.vimeo, videoId);
    ...
    key: 'getVimeoShowcase',
    value: function getVimeoShowcaseUrl(vimeo, videoId) {
      var query = this.getQueryString(vimeo);
      return '//vimeo.com/showcase/'+ videoId +'/embed?' + query;
    }
  }, {
    key: 'getYoutubeUrl',
